  ...
  while cont != 10:
      for event in pygame.event.get():
          if event.type == QUIT:
              pygame.quit()
              sys.exit()
      pygame.draw.rect(telaperdedor, (255, 0, 0), (0, 200, 500, 70))
      texto = fonte.render("Você Perdeu!", True, (250, 255, 255))
      telaperdedor.blit(texto, (120, 212))
      cont += 1
      time.sleep(1)
      pygame.display.update()
  ...
  while cont != 10:
      for event in pygame.event.get():
          if event.type == QUIT:
              pygame.quit()
              sys.exit()
      pygame.draw.rect(telaganhador, (0, 255, 0), (0, 200, 500, 70))
      texto = fonte.render("Você Ganhou!", True, (255, 255, 255))
      telaganhador.blit(texto, (120, 212))
      cont += 1
      time.sleep(1)
      pygame.display.update()
